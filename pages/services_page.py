...
def process_with_gpt(groq_api_key, transcription, purpose, audience, duration, tone, additional_requirements, topic, speech_analysis):
    try:
        ...
        if st.button("Process Speech"):
            ...
            try:
                ...
                original, refined, feedback = process_with_gpt(
                    groq_api_key, transcription, purpose, audience, duration, tone, additional_requirements, topic_of_speech, results
                )
